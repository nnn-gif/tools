...
import { ref } from 'vue'
import { FileCode, Sparkles, Upload } from 'lucide-vue-next'
...
<template>
  <div class="flex h-screen flex-col bg-background text-foreground font-sans">
    <!-- Header -->
    <header class="flex h-14 items-center justify-between border-b border-border px-6 shadow-sm">
      <div class="flex items-center gap-2">
        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-primary text-primary-foreground">
          <FileCode class="h-5 w-5" />
        </div>
        <h1 class="text-lg font-bold tracking-tight text-foreground">Markdown Tools</h1>
      </div>
    ...
    <!-- Mobile Preview Toggle (Simple MVP approach) -->
    <div class="md:hidden absolute bottom-4 right-4 bg-primary text-primary-foreground p-3 rounded-full shadow-lg">
